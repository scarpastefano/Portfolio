<x-main>
    ...
    <div class="container-sm bg-gray-700 py-12 my-28 min-h-screen">
        
        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
            <thead>
                <tr class="py-12 border bg-gray-600">
                    <th scope="col" class="text-gray-50 px-6 py-4">#</th>
                    <th scope="col" class="text-gray-50 px-6 py-4">Immagine</th>
                    <th scope="col" class="text-gray-50 px-6 py-4">Titolo</th>
                    <th scope="col" class="text-gray-50 px-6 py-4 text-end">Azioni</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($posts as $post)    
                <tr class="my-12 border border-orange-500">
                    <th scope="row" class="text-gray-50 px-6 py-4 whitespace-nowrap">#{{ $post->id }}</th>
                    <td class="text-gray-50 text-sm px-6 py-4"><img class="w-16" src="{{ Storage::url($post->image) }}" alt="Nessuna immagine"></td>
                    <td class="text-gray-50 px-6 py-4">{{ $post->title }}</td>
                    <td class="text-gray-50 px-6 py-4">
