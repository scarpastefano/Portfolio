                        ...
                        <td class="text-zinc-50 px-6 py-3">
                            <div class="flex flex-row justify-end">
                                ...
                                <a href="{{ route('post.show', ['post' => $post->id]) }}"
                                    class="btn me-md-2 stroke-zinc-50 hover:bg-orange-500 bg-orange-400 rounded-full">
                                    <svg class="stroke-zinc-50 " fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><g class="stroke-zinc-50" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m1 12s4-8 11-8 11 8 11 8"/><path d="m1 12s4 8 11 8 11-8 11-8"/><circle cx="12" cy="12" r="3"/></g></svg>
                                </a>
                                <a href="{{ route('post.edit', ['post' => $post->id]) }}"
                                    class="btn me-md-2 bg-orange-400 rounded-full hover:bg-orange-500">
                                    <svg class="stroke-zinc-50"
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
