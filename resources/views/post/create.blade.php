<x-main>
    ...
    <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data" class="my-28 container-sm">
        ...
        <div class="flex items-center justify-center w-full">
            <label for="image" class=" mb-6 flex flex-col items-center justify-center w-full h-64 border-1 border-gray-300 border-solid rounded-lg cursor-pointer bg-gray-700">
