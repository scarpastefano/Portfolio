  ...
  <div class="container-xl flex flex-wrap items-center justify-between mx-auto">
    ...
    <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      ...
      <a href="{{route('contacts')}}">
        <button type="button" class="border-orange-500 border-1 hidden lg:block text-orange-500 hover:bg-orange-700 hover:text-white hover:border-transparent focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-2 text-md px-4 py-2 text-center">Contattami</button>
      </a>
