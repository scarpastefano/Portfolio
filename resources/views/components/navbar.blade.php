<nav class="bg-transparent border-dark-800 dark:bg-dark-900 container-none p-3 m-0 fixed top-0 w-full z-50 backdrop-blur-sm">
    ...
    <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      ...
      <a href="{{route('contacts')}}">
        <button type="button" class="border-0 text-white bg-orange-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-md px-4 py-2 text-center dark:bg-orange-500 dark:focus:ring-orange-500">Contattami</button>
      </a>
